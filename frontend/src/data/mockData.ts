...
// Open Tables (Açık Masalar) - Aynı müşterinin farklı lokasyonlardaki verileri ayrı gösteriliyor
export const openTablesData: OpenTable[] = [
  // Ahmet Yılmaz - 3 farklı data (3 farklı lokasyonda açık masası var)
  {
    id: 'ot-1',
    tableNo: 'Masa 5',
  ...
  },
  {
    ...
    openedAt: '2025-07-15 11:00',
    itemCount: 12,
    dataSource: 'Data 3',
  },
  // Mehmet Kaya - 2 farklı data
  {
    id: 'ot-4',
    tableNo: 'Masa 8',
  ...
  },
  {
    ...
    openedAt: '2025-07-15 10:45',
    itemCount: 9,
    dataSource: 'Data 2',
  },
  // Ayşe Demir - 3 farklı data
  {
    id: 'ot-6',
    tableNo: 'Masa 2',
  ...
  // Fatma Öztürk - 1 data
  {
    ...
    location: 'Merkez Şube',
    openedAt: '2025-07-15 16:00',
    itemCount: 6,
    dataSource: 'Data 1',
  },
  // Ali Şahin - 2 farklı data
  {
    id: 'ot-10',
    tableNo: 'Masa 9',
